...
export default defineComponent({
  ...
  setup(_, { emit }) {
    ...
    const experience = ref([
      {
        id: 1,
        title: "SWE Co-op",
        company: "Reactiv Technologies",
        period: "September 2025 - Present",
        description: "Excited to improve mobile merchant experiences!!",
        icon: new URL(
          "../assets/experience/reactiv.png",
          import.meta.url
        ).toString(),
      },
      {
        ...
        description:
          "Worked on the Flywheel Product team at Hubspot to develop tools for HubSpot Sales reps!!",
        icon: new URL(
    ...
    const handleStartDrag = (event: MouseEvent) => {
      if (window.ds) {
        startDrag(event, event.currentTarget as Element, emit, window.ds);
      }
    };
